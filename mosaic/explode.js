...
explode.prototype.boom = function() {
  ...
  if (this.clicked === false) {
    ...
    (function($) {
      ...
      $('.clipped-box div').each(function(i, el) {
        ...
        var v = _self.rand(120, 90),
          angle = _self.rand(89, 80), // The angle (the angle of projection) is a random number between 80 and 89 degrees.
        ...
        var color = $(el).css('backgroundColor').split('rgb(')[1].split(')')[0].split(', '),
          colorR = _self.rand(-20, 20),  // You might want to alter these manually if you change the color
          colorGB = _self.rand(-20, 20),  // To get the right consistency.
        ...
        z = setInterval(function() {
          ...
          // Apply the positions
          $(el).css({'bottom': (ny) + 'px', 'left': (nx) + 'px'});
